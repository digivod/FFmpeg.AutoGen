...
public static unsafe partial class DynamicallyLinkedMacBindings
{
    const string avutil = "libavutil.57.dylib";
    const string swresample = "libswresample.4.dylib";
    const string postproc = "libpostproc.56.dylib";
    const string swscale = "libswscale.6.dylib";
    const string avcodec = "libavcodec.59.dylib";
    const string avfilter = "libavfilter.8.dylib";
    const string avdevice = "libavdevice.59.dylib";
    const string avformat = "libavformat.59.dylib";
    ...
    [DllImport(postproc, CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
