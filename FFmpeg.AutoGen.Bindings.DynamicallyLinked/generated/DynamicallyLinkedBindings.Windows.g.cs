...
public static unsafe partial class DynamicallyLinkedWindowsBindings
{
    const string avutil = "avutil-57.dll";
    const string swresample = "swresample-4.dll";
    const string postproc = "postproc-56.dll";
    const string swscale = "swscale-6.dll";
    const string avcodec = "avcodec-59.dll";
    const string avfilter = "avfilter-8.dll";
    const string avdevice = "avdevice-59.dll";
    const string avformat = "avformat-59.dll";
