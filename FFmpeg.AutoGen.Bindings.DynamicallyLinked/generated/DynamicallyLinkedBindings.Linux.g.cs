...
public static unsafe partial class DynamicallyLinkedLinuxBindings
{
    const string avutil = "libavutil.so.57";
    const string swresample = "libswresample.so.4";
    const string postproc = "libpostproc.so.56";
    const string swscale = "libswscale.so.6";
    const string avcodec = "libavcodec.so.59";
    const string avfilter = "libavfilter.so.8";
    const string avdevice = "libavdevice.so.59";
    const string avformat = "libavformat.so.59";
